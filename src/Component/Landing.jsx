    ...
    return (
        <div className="h-[100%] w-[100vw] bg-[#FCF7F2] lg:h-[100vh] flex flex-col ">
            <nav className="flex flex-col justify-start lg:flex-row lg:items-center lg:justify-between  lg:mx-10 lg:py-5  ">
                ...
                <div>
                    <Link to='/login'>
                        <Button className=" py-2 mr-10 text-xl text-white bg-black rounded-xl hover:bg-stone-900 transition-all">Log in</Button>
                    </Link>
                    <Link to='/signup'>
                        <Button className="py-2 mr-10 text-xl text-white bg-black rounded-xl hover:bg-stone-900 transition-all">Sign in</Button>
                    </Link>
                </div>
            </nav>
            ...
            <div className="flex h-[90%] flex-1  flex-col lg:flex-row">
                ...
                <div className="w-[100%] h-[100%] text-[16px]  flex flex-col items-center lg:items-start lg:text-[25px] lg:py-[150px] justify-center">
                    ...
                    <Button className="py-2 mr-10 text-xl text-white bg-black rounded-xl hover:bg-stone-900 transition-all"><Link to='/convert'>
